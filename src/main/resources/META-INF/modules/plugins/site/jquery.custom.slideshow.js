...
jQuery(document).ready(function($){
	...
	var local = {
		"themeSettings": {
			"mobileHeader": {
				"firstSwitchPoint": 850,
				"secondSwitchPoint": 850
			}
		}
	};
            ...
            var $sliderData = $slider.thePhotoSlider({
                ...
                height: function() {
                    ...
                    if ($body.hasClass("transparent") || $slider.parents(".photo-scroller").hasClass("full-screen")) {
                        ...
                        if(window.innerWidth < local.themeSettings.mobileHeader.secondSwitchPoint) {
                        ...
                        if(window.innerWidth < local.themeSettings.mobileHeader.firstSwitchPoint) {
                            return ($windowH - $slideTopPadding - $slideBottomPadding - $headerH - $adminBarH);                 
                        }else {
